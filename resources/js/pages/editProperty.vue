        ...
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm leading-5 text-gray-600">
                    Esta é a propriedade: #{{ property.id }} com status <strong>{{ property.status == 'S' ? 'contratada' : 'não contratada'}}</strong>
                </p>
            </div>
        </div>
                ...
                <div class="shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="col-span-8">
                            ...
                            <input id="email_property" required v-model="property.email_property" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        ...
                        <div class="col-span-6">
                            ...
                            <input id="street" required v-model="property.street" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        ...
                        <div class="col-span-4">
                            ...
                            <input id="neighborhood" required v-model="property.neighborhood" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        ...
                        <div class="col-span-4">
                            ...
                            <input id="city" required v-model="property.city" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        ...
                        <div class="col-span-4">
                            ...
                            <input id="state" required v-model="property.state" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
